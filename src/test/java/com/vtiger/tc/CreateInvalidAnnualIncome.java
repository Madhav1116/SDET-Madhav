...
public class CreateInvalidAnnualIncome extends BaseClass
{
	...
	public void createLead()  throws IOException
	{
		...
		//Read data from property file
				...
				String fName=eu.readDatafromExcel("Create Lead", 2, 0);
				String lName=eu.readDatafromExcel("Create Lead", 2, 1);
				String company=eu.readDatafromExcel("Create Lead", 2, 2);
				String annualIncome=(eu.readDatafromExcel("Create Lead", 2, 3));
				...
				cl.getAnnualIncome().sendKeys(annualIncome);
				cl.getSave().click();
