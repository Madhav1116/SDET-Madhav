...
public class CreateLeadNoOfEmp extends BaseClass
{
	...
	public void createLead()  throws IOException
	{
		...
		//Read data from property file
				...
				String fName=eu.readDatafromExcel("Create Lead", 3, 0);
				String lName=eu.readDatafromExcel("Create Lead", 3, 1);
				String company=eu.readDatafromExcel("Create Lead", 3, 2);
				String noOfEmp=(eu.readDatafromExcel("Create Lead", 3, 4));
